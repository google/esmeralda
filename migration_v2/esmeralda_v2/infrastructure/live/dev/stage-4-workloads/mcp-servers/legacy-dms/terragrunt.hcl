...
terraform {
  source = "../../../../../../modules//4-workloads/mcp-servers/legacy-dms"
}
...
inputs = {
  ...
  container_image          = "${local.env_vars.locals.region}-docker.pkg.dev/${dependency.projects.outputs.mcps_project_id}/remote-mcp-servers/legacy-dms:latest"
