...
## Composable MCP Server Tools (`modules/4-workloads/mcp-servers/`)
...
### 1. Corporate Email Server (`mcp-servers/corporate-email/`)
...
### 2. Income Verification Server (`mcp-servers/income-verification/`)
...
### 3. Legacy DMS Server (`mcp-servers/legacy-dms/`)
