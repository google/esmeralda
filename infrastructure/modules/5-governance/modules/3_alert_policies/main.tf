...
moved {
  ...
  to   = google_logging_metric.realtime_token_consumption["esmeralda-governance-3a3d"]
}

moved {
  from = google_logging_metric.cached_tokens_counter
  to   = google_logging_metric.cached_tokens_counter["esmeralda-governance-3a3d"]
}

moved {
  from = google_logging_metric.prompt_tokens_counter
  to   = google_logging_metric.prompt_tokens_counter["esmeralda-governance-3a3d"]
}

moved {
  from = google_logging_metric.completion_tokens_counter
  to   = google_logging_metric.completion_tokens_counter["esmeralda-governance-3a3d"]
}

moved {
  from = google_logging_metric.thoughts_tokens_counter
  to   = google_logging_metric.thoughts_tokens_counter["esmeralda-governance-3a3d"]
}

moved {
  from = google_logging_metric.mcp_tool_execution_count
  to   = google_logging_metric.mcp_tool_execution_count["esmeralda-governance-3a3d"]
}
