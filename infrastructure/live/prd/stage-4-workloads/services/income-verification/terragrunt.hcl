# infrastructure/live/dev/stage-4-workloads/mcp-servers/income-verification/terragrunt.hcl
include "root" {
  path = find_in_parent_folders()
}

terraform {
  source = "../../../../../modules//4-workloads/services/income-verification"
}
...
inputs = {
  ...
  container_image          = "${local.env_vars.locals.region}-docker.pkg.dev/${dependency.projects.outputs.cicd_project_id}/esmeralda-containers/income-verification-api:${lookup(local.env_vars.locals, "container_tag", "latest")}"
