...
inputs = {
  ...
  container_image          = "${local.env_vars.locals.region}-docker.pkg.dev/${dependency.projects.outputs.cicd_project_id}/esmeralda-containers/legacy-dms:${lookup(local.env_vars.locals, "container_tag", "latest")}"
