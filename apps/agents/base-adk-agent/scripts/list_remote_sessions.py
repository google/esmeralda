...
async def main():
    ...
    ROOT_PROJECT_ID = os.getenv("ROOT_AGENT_PROJECT_ID", "esmeralda-root-agent-3a3d")
    ROOT_RESOURCE_ID = os.getenv("ROOT_REASONING_ENGINE_ID", "864970954164404224")
    ...
    A2A_PROJECT_ID = os.getenv("A2A_AGENT_PROJECT_ID", "esmeralda-a2a-agent-3a3d")
